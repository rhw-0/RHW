...
RHW is an installable Progressive Web App. Open the GitHub Pages site in Samsung Internet, tap the menu (☰), then choose **Add page to → Home screen**. In Chrome for Android, open the menu (⋮) and choose **Install app** or **Add to Home screen**. RHW then launches in its own full-screen app window with local branding.
